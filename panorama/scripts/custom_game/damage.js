...
function InitPlayer(name)
{
	...
	panel.FindChildTraverse('hero_name').heroname = "npc_dota_hero_" + name.name;
...
{
	if(players[damage.id]){players[damage.id].FindChildTraverse('PlayerDamageDealt').text = damage.damage;}
}	
function SetDamageTaken(damage)
{
	if(players[damage.id]){players[damage.id].FindChildTraverse('PlayerDamageTaken').text = damage.damage;}
}	
